...
class advancephp_mcq extends JFrame implements ActionListener, MenuListener{
    JMenu compiler;
	...
	advancephp_mcq(){
        ...
        InputStream font=advancephp_mcq.class.getResourceAsStream("font/Poppins-Regular.ttf");
        Font myfont=null;
        try{
        ...
        panel.add(q1c);
        panel.add(q1d);
        JLabel Que2=new JLabel("<html>2. Which of the following statement is true regarding UTF-8 encoding in XML?</html>");
        Que2.setBounds(300,360,750,100);
        Que2.setFont(myfont.deriveFont(20f));
        Que2.setForeground(Color.white);
        panel.add(Que2);
        q2a = new JRadioButton("UTF-8 is the default encoding for XML documents.",false);
        q2a.setBounds(320,430,600,30);
        q2a.setOpaque(false);
        q2a.setFocusPainted(false);
        q2a.setFont(myfont.deriveFont(18f));
        q2a.setForeground(Color.white);
        q2b = new JRadioButton("UTF-8 can only represent characters from ASCII character set.");
        q2b.setBounds(320,460,600,30);
        q2b.setOpaque(false);
        q2b.setFocusPainted(false);
        q2b.setFont(myfont.deriveFont(18f));
        q2b.setForeground(Color.white);
        q2c = new JRadioButton("UTF-8 uses a fixed length encoding scheme for all characters.");
        q2c.setBounds(320,490,600,30);
        q2c.setOpaque(false);
        q2c.setFocusPainted(false);
        q2c.setFont(myfont.deriveFont(18f));
        q2c.setForeground(Color.white);
        q2d = new JRadioButton("UTF-8 is not compatible with XML and should be avoided.");
        q2d.setBounds(320,520,600,30);
        q2d.setOpaque(false);
        ...
        panel.add(q2c);
        panel.add(q2d);
        JLabel Que3=new JLabel("<html>3. Consider a form with multiple input fields. You want to implement sticky form functionality in PHP, where the form retains the user's input even after submitting. Which of the following method can be used to achieve this?</html>");
        Que3.setBounds(300,550,800,120);
        Que3.setFont(myfont.deriveFont(20f));
        Que3.setForeground(Color.white);
        panel.add(Que3);
        q3a = new JRadioButton("$_POST",false);
        q3a.setBounds(320,660,200,30);
        q3a.setOpaque(false);
        q3a.setFocusPainted(false);
        q3a.setFont(myfont.deriveFont(18f));
        q3a.setForeground(Color.white);
        q3b = new JRadioButton("$_GET");
        q3b.setBounds(320,690,200,30);
        q3b.setOpaque(false);
        q3b.setFocusPainted(false);
        q3b.setFont(myfont.deriveFont(18f));
        q3b.setForeground(Color.white);
        q3c = new JRadioButton("$_GET & $_POST");
        q3c.setBounds(320,720,200,30);
        q3c.setOpaque(false);
        q3c.setFocusPainted(false);
        q3c.setFont(myfont.deriveFont(18f));
        q3c.setForeground(Color.white);
        q3d = new JRadioButton("Using Javascript");
        q3d.setBounds(320,750,200,30);
        q3d.setOpaque(false);
        ...
        panel.add(q3c);
        panel.add(q3d);
        JLabel Que4=new JLabel("<html>4. Guess the output: <?php class DISTANCE{  function __construct($a,$b=12){ echo $a; echo $b; } } $obj=new DISTANCE(10,10); ?>/html>");
        Que4.setBounds(300,780,750,100);
        Que4.setFont(myfont.deriveFont(20f));
        Que4.setForeground(Color.white);
        panel.add(Que4);
        q4a = new JRadioButton("1010",false);
        q4a.setBounds(320,870,200,30);
        q4a.setOpaque(false);
        q4a.setFocusPainted(false);
        q4a.setFont(myfont.deriveFont(18f));
        q4a.setForeground(Color.white);
        q4b = new JRadioButton("1012");
        q4b.setBounds(320,900,200,30);
        q4b.setOpaque(false);
        q4b.setFocusPainted(false);
        q4b.setFont(myfont.deriveFont(18f));
        q4b.setForeground(Color.white);
        q4c = new JRadioButton("Error");
        q4c.setBounds(320,930,200,30);
        q4c.setOpaque(false);
        q4c.setFocusPainted(false);
        q4c.setFont(myfont.deriveFont(18f));
        q4c.setForeground(Color.white);
        q4d = new JRadioButton("10 10");
        q4d.setBounds(320,960,200,30);
        q4d.setOpaque(false);
        ...
        panel.add(q4c);
        panel.add(q4d);
        JLabel Que5=new JLabel("<html>5. What is the purpose of 4 ready state in Ajax program?</html>");
        Que5.setBounds(300,980,750,100);
        Que5.setFont(myfont.deriveFont(20f));
        Que5.setForeground(Color.white);
        panel.add(Que5);
        q5a = new JRadioButton("UNSET - The request is not been initialized",false);
        q5a.setBounds(320,1050,500,30);
        q5a.setOpaque(false);
        q5a.setFocusPainted(false);
        q5a.setFont(myfont.deriveFont(18f));
        q5a.setForeground(Color.white);
        q5b = new JRadioButton("OPENED - Request has been set up, but the connection has not been made yet.");
        q5b.setBounds(320,1080,720,30);
        q5b.setOpaque(false);
        q5b.setFocusPainted(false);
        q5b.setFont(myfont.deriveFont(18f));
        q5b.setForeground(Color.white);
        q5c = new JRadioButton("DONE - it means that the request has been completed, and response is ready to be used.");
        q5c.setBounds(320,1110,500,30);
        q5c.setOpaque(false);
        q5c.setFocusPainted(false);
        q5c.setFont(myfont.deriveFont(18f));
        q5c.setForeground(Color.white);
        q5d = new JRadioButton("LOADING - it means that the server is processing the request and sending back the repsonse");
        q5d.setBounds(320,1140,500,30);
        q5d.setOpaque(false);
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(() -> new advancephp_mcq());
