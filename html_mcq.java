...
class html_mcq extends JFrame implements ActionListener, MenuListener{
    JMenu compiler;
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(() -> new html_mcq());
