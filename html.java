...
import java.io.*;
import java.sql.*;
class html extends JFrame implements ActionListener{
	...
	html(){
        InputStream font=html.class.getResourceAsStream("font/Poppins-Regular.ttf");
        Font myfont=null;
        try{
        ...
        this.add(p1);*/
		JLabel tagline=new JLabel("<html>&nbsp;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;HTML</html>");
        ...
        this.add(tagline);
        JLabel ch1=new JLabel("<html>1. Basic HTML Tags</html>");
        ...
        this.add(button1);
        JLabel ch2=new JLabel("<html>2. Creating Lists Through HTML</html>");
        ...
        this.add(button2);
        JLabel ch3=new JLabel("<html>3. Creating Tables Through HTML</html>");
        ...
        this.add(button3);
        JLabel ch4=new JLabel("<html>4. Creating Frames Through HTML</html>");
        ...
        this.add(button4);
        JLabel ch5=new JLabel("<html>5. Creating Forms Through HTML</html>");
        ...
        this.add(button5);
        JLabel ch6=new JLabel("<html>6. Image Mapping</html>");
        ...
        this.add(button6);
        JLabel ch7=new JLabel("<html>7. Frames Examples</html>");
        ...
        this.add(button7);
        JLabel ch8=new JLabel("<html>8. Javascript</html>");
    ...
    public void getconn1(){
        ...
        try{
            ...
            ResultSet res1=state.executeQuery("select * from html where name='Assignment 1'");
            while(res1.next()){
        ...
        try{
            ...
            ResultSet res2=state2.executeQuery("select * from html where name='Assignment 2'");
            while(res2.next()){
    ...
    public void getconn3(){
        ...
        try{
            ...
            ResultSet res3=state3.executeQuery("select * from html where name='Assignment 3'");
            while(res3.next()){
    ...
    public void getconn4(){
        ...
        try{
            ...
            ResultSet res4=state4.executeQuery("select * from html where name='Assignment 4'");
            while(res4.next()){
    ...
    public void getconn5(){
        ...
        try{
            ...
            ResultSet res5=state5.executeQuery("select * from html where name='Assignment 5'");
            while(res5.next()){
    ...
    public void getconn6(){
        ...
        try{
            ...
            ResultSet res6=state6.executeQuery("select * from html where name='Assignment 6'");
            while(res6.next()){
    ...
    public void getconn7(){
        ...
        try{
            ...
            ResultSet res7=state7.executeQuery("select * from html where name='Homework'");
            while(res7.next()){
