...
class java extends JFrame implements ActionListener{
	...
	java(){
        ...
        this.add(p1);*/
		JLabel tagline=new JLabel("<html>&#160;&#160;&nbsp;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Core Java</html>");
        ...
        this.add(tagline);
        JLabel ch1=new JLabel("<html>1. Introduction to Java</html>");
        ...
        this.add(btn1);
        JLabel ch2=new JLabel("<html>2. Classes Objects & Methods</html>");
        ...
        this.add(btn2);
        /*JLabel ch3=new JLabel("<html>3. inheritance, Package & Collection</html>");
        ...
        this.add(btn3);*/
        JLabel ch4=new JLabel("<html>3. Inheritance Package and Collection</html>");
        ...
        this.add(btn4);
        JLabel ch5=new JLabel("<html>4. File & Exception Handling</html>");
        ...
        this.add(btn5);
        JLabel ch6=new JLabel("<html>5. AWT, Applet & Swing</html>");
    ...
    public void getconn1(){
        ...
        try{
            ...
            ResultSet res1=state.executeQuery("select * from java where name='Assignment 1'");
            while(res1.next()){
        ...
        try{
            ...
            ResultSet res2=state2.executeQuery("select * from java where name='Assignment 2'");
            while(res2.next()){
    ...
    public void getconn3(){
        ...
        try{
            ...
            ResultSet res3=state3.executeQuery("select * from java where name='Assignment 3'");
            while(res3.next()){
    ...
    public void getconn4(){
        ...
        try{
            ...
            ResultSet res4=state4.executeQuery("select * from java where name='Assignment 4'");
            while(res4.next()){
    ...
    public void getconn5(){
        ...
        try{
            ...
            ResultSet res5=state5.executeQuery("select * from java where name='Assignment 5'");
            while(res5.next()){
