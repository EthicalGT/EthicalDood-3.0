...
import java.io.*;
import java.sql.*;
class php extends JFrame implements ActionListener{
	...
	php(){
        ...
        this.add(p1);*/
		JLabel tagline=new JLabel("<html>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;PHP</html>");
        ...
        JLabel ch1=new JLabel("<html>1. Basics in PHP</html>");
        ...
        this.add(btn1);
        JLabel ch2=new JLabel("<html>2. Control Structures and Loops</html>");
        ...
        this.add(btn3);
        JLabel ch4=new JLabel("<html>3. Arrays and Strings</html>");
        ...
        this.add(btn4);
        JLabel ch5=new JLabel("<html>4. Function, Class and Objects</html>");
        ...
        this.add(btn5);
        JLabel ch6=new JLabel("<html>5. Working With Form</html>");
        ...
        this.add(btn6);
        JLabel ch7=new JLabel("<html>6. Session and Cookies</html>");
    ...
    public void getconn1(){
        ...
        try{
            ...
            ResultSet res1=state.executeQuery("select * from php where name='Assignment 1'");
            while(res1.next()){
        ...
        try{
            ...
            ResultSet res2=state2.executeQuery("select * from php where name='Assignment 2'");
            while(res2.next()){
    ...
    public void getconn3(){
        ...
        try{
            ...
            ResultSet res3=state3.executeQuery("select * from php where name='Assignment 3'");
            while(res3.next()){
    ...
    public void getconn4(){
        ...
        try{
            ...
            ResultSet res4=state4.executeQuery("select * from php where name='Assignment 4'");
            while(res4.next()){
    ...
    public void getconn5(){
        ...
        try{
            ...
            ResultSet res5=state5.executeQuery("select * from php where name='Assignment 5'");
            while(res5.next()){
    ...
    public void getconn6(){
        ...
        try{
            ...
            ResultSet res6=state6.executeQuery("select * from php where name='Assignment 6'");
            while(res6.next()){
