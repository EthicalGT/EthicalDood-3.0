...
class android_mcq extends JFrame implements ActionListener, MenuListener{
    JMenu compiler;
	...
	android_mcq(){
        ...
        InputStream font=android_mcq.class.getResourceAsStream("font/Poppins-Regular.ttf");
        Font myfont=null;
        try{
        ...
        panel.add(q2c);
        panel.add(q2d);
        JLabel Que3=new JLabel("<html>3. Which of the following is true about Android's Activity and Fragment lifecycle methods?</html>");
        Que3.setBounds(300,550,800,120);
        Que3.setFont(myfont.deriveFont(20f));
        Que3.setForeground(Color.white);
        panel.add(Que3);
        q3a = new JRadioButton("They both have a method called onCreateView()",false);
        q3a.setBounds(320,660,700,30);
        q3a.setOpaque(false);
        q3a.setFocusPainted(false);
        q3a.setFont(myfont.deriveFont(18f));
        q3a.setForeground(Color.white);
        q3b = new JRadioButton("Fragment has more lifecycle methods compared to Activity");
        q3b.setBounds(320,690,700,30);
        q3b.setOpaque(false);
        q3b.setFocusPainted(false);
        q3b.setFont(myfont.deriveFont(18f));
        q3b.setForeground(Color.white);
        q3c = new JRadioButton("Activity can exist without being attached to a UI, but Fragment cannot");
        q3c.setBounds(320,720,700,30);
        q3c.setOpaque(false);
        q3c.setFocusPainted(false);
        q3c.setFont(myfont.deriveFont(18f));
        q3c.setForeground(Color.white);
        q3d = new JRadioButton("Activity and Fragment have the same set of lifecycle methods");
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(() -> new android_mcq());
